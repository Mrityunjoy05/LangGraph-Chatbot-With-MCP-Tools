...
class Agent_Manager:
    def __init__(self, 
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ("system", "You are a helpful and professional AI assistant. "
                       ...
                       "delete_repository — permanently delete a repo (be careful)"
                        "list_repositories — list GitHub repos"
                       ),
    ...
    async def initialize(self) -> CompiledStateGraph:
        ...
        # KEY: interrupt_before stops the graph so we can check the tool call
